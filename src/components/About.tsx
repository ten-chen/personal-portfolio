      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-left">
            <div className="rounded-lg overflow-hidden bg-gradient-to-br from-sky-500/10 to-cyan-700/5 p-8 border border-sky-500/20">
              <div className="aspect-video bg-gradient-to-br from-sky-600 to-cyan-800 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  <div className="text-6xl font-bold text-sky-400 opacity-20">OAA</div>
                  <p className="text-sky-300/50 mt-2">Your photo here</p>
                </div>
              </div>
            </div>
          </div>
          <div className="space-y-6 animate-slide-right">
            <div>
              <h3 className="text-2xl font-bold text-sky-400 mb-3">Computer Engineer Student & Full-Stack Web Developer</h3>
